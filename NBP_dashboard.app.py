...
st.markdown('<h6 style="color:black; font-size:20px;">Whether you are analyzing trends or exploring specific sightings, this tool provides insights into our local bird populations and their ecology.</h6>', unsafe_allow_html=True) 
